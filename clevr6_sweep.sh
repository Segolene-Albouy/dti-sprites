...
#python -m src.sprites_trainer --multirun +dataset=clevr6 +model=clevr6_mlp_proba +training=clevr6 ++model.softmax=gumbel_softmax,softmax ++training.seed=123,958 
